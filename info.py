...
PICS = (environ.get('PICS', 'https://telegra.ph/file/3abd4de63dd495476bb60.jpg')).split()
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Fireboy:harii@fucking.guwxy7e.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "fucking")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/tamil_rockerZ_1')
MSG_ALRT = environ.get('MSG_ALRT', 'ᴠᴀʟᴀʀ ᴍᴏʀɢʜᴜʟɪs!')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002124577913'))
